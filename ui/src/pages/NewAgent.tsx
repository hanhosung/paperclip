...
export function NewAgent() {
  ...
  useEffect(() => {
    setBreadcrumbs([
      { label: t("agents.list.breadcrumb"), href: "/agents" },
  ...
  function handleSubmit() {
    ...
    if (configValues.adapterType === "opencode_local") {
      if (!isValidOpenCodeModelId(configValues.model)) {
        setFormError(t("agents.new.openCodeModelError"));
        return;
      }
    }
    createAgent.mutate(
    ...
    <div className="mx-auto max-w-2xl space-y-6">
      ...
      <div className="border border-border">
          ...
          <div className="space-y-3">
            <div>
              ...
              <p className="mt-1 text-xs text-muted-foreground">
                {t("agents.new.companySkillsHelp")}
              </p>
            </div>
        ...
        <div className="border-t border-border px-4 py-3">
          {isFirstAgent && (
            <p className="text-xs text-muted-foreground mb-2">{t("agents.new.willBeCeo")}</p>
          )}
          {formError && (
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center justify-between gap-2">
              ...
              <div className="flex items-center gap-2">
                ...
                >
                  {testAgentState.pending ? t("agents.new.testing") : t("agents.new.testAgent")}
                </Button>
                <Button
                  size="sm"
