        ...
        <>
              ...
              <div className="flex items-start gap-2.5">
                ...
                <div>
                  ...
                  <p className="text-xs text-red-100/70">
                    {t("dashboard.budgetIncidentDetail", {
          ...
          <div className="grid grid-cols-2 xl:grid-cols-4 gap-1 sm:gap-2">
            <MetricCard
              ...
              to="/agents"
              description={t("dashboard.metrics.agentsDetail", {
            ...
            <MetricCard
              ...
              to="/issues"
              description={t("dashboard.metrics.tasksDetail", {
            ...
            <MetricCard
              ...
              description={
                data.budgets.pendingApprovals > 0
                  ? t("dashboard.metrics.budgetOverridesPending", { n: data.budgets.pendingApprovals })
