...
import { goalLevelKey } from "../lib/enum-labels";
...
export function NewGoalDialog() {
  ...
  const uploadDescriptionImage = useMutation({
    mutationFn: async (file: File) => {
      if (!selectedCompanyId) throw new Error(t("goals.newDialog.noCompanySelected"));
      ...
      >
        ...
        <div className="flex items-center justify-between px-4 py-2.5 border-b border-border">
          <div className="flex items-center gap-2 text-sm text-muted-foreground">
            ...
            <span>{newGoalDefaults.parentId ? t("goals.newDialog.newSubGoal") : t("goals.newDialog.newGoal")}</span>
          </div>
        ...
        <div className="flex items-center justify-end px-4 py-2.5 border-t border-border">
          ...
          >
            {createGoal.isPending
              ? t("goals.newDialog.creating")
              : newGoalDefaults.parentId
                ? t("goals.newDialog.createSubGoal")
                : t("goals.newDialog.createGoal")}
          </Button>
        </div>
      </DialogContent>
    </Dialog>
