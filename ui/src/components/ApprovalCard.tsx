...
export function ApprovalCard({
  ...
  const kindLabel = t(typeLabelKey(approval.type), { defaultValue: approval.type });
            ...
            <div className="min-w-0 flex-1 space-y-2">
              ...
              <div className="space-y-1">
                ...
                <p className="text-xs leading-5 text-muted-foreground">
                  {t("approvals.card.createdAgo", { time: timeAgo(approval.createdAt) })}
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="shrink-0">
          <div className="inline-flex items-center gap-1.5 rounded-full border border-border/70 bg-background/80 px-2.5 py-1 text-xs text-muted-foreground">
            ...
            <span className="capitalize">
              {t(`statusBadge.${approval.status}`, { defaultValue: approval.status.replace(/_/g, " ") })}
            </span>
          </div>
        </div>
      </div>
