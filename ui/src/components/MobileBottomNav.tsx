...
export function MobileBottomNav({ visible }: MobileBottomNavProps) {
  ...
  const items = useMemo<MobileNavItem[]>(
    () => [
      { type: "link", to: "/dashboard", label: t("chrome.mobileNav.home"), icon: House },
      { type: "link", to: "/issues", label: t("chrome.mobileNav.issues"), icon: CircleDot },
      { type: "action", label: t("chrome.mobileNav.create"), icon: SquarePen, onClick: () => openNewIssue() },
      { type: "link", to: "/agents/all", label: t("chrome.mobileNav.agents"), icon: Users },
      {
        type: "link",
        to: "/inbox",
        label: t("chrome.mobileNav.inbox"),
        icon: Inbox,
  ...
  return (
    <nav
      ...
      aria-label={t("chrome.mobileNav.navLabel")}
    >
