    ...
    <CommandDialog
      ...
      <CommandList>
        <CommandEmpty>
          {showSearchAll ? (
            <span>
              {t("commandPalette.emptyHintBefore")}
              <kbd className="rounded border border-border bg-muted px-1 py-0.5 text-[10px]">↵</kbd>{" "}
              <span className="font-medium">{t("commandPalette.emptyHintAction")}</span>
              {t("commandPalette.emptyHintAfter")}
            </span>
          ) : (
          ...
          <CommandGroup heading={t("commandPalette.groups.search")}>
            ...
            >
              ...
              <span className="flex-1 truncate">
                {t("commandPalette.searchAllBefore")}
